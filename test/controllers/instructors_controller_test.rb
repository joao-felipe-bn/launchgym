...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference("Instructor.count") do
      post instructors_url, params: { instructor: { birth: @instructor.birth, document: @instructor.document, email: @instructor.email, name: @instructor.name, phone: @instructor.phone, specialities: @instructor.specialities, user_id: @instructor.user_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { birth: @instructor.birth, document: @instructor.document, email: @instructor.email, name: @instructor.name, phone: @instructor.phone, specialities: @instructor.specialities, user_id: @instructor.user_id } }
