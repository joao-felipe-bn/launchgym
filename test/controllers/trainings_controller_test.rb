...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { durantion_minutes: @training.durantion_minutes, name: @training.name, reps: @training.reps, single: @training.single } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { durantion_minutes: @training.durantion_minutes, name: @training.name, reps: @training.reps, single: @training.single } }
